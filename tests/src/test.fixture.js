...
const PLUGIN_LIB_NANOS = { 'Poap': Resolve('elfs/poap_nanos.elf') };
const PLUGIN_LIB_NANOX = { 'Poap': Resolve('elfs/poap_nanox.elf') };
const PLUGIN_LIB_NANOSP = { 'Poap': Resolve('elfs/poap_nanosp.elf') };
